...
insert into play_list_track_entities (play_list_id, track_entities_id) values (1, 1);
insert into play_list_track_entities (play_list_id, track_entities_id) values (1, 2);

insert into like_track (date, track_entity_id, user_entity_id, liked ) values (current_timestamp(), 1, 2, 1);
insert into like_track (date, track_entity_id, user_entity_id, liked ) values (current_timestamp(), 1, 1, 1);
insert into like_track (date, track_entity_id, user_entity_id, liked ) values (current_timestamp(), 1, 3, 1);
insert into like_track (date, track_entity_id, user_entity_id, liked ) values (current_timestamp(), 2, 2, 1);
insert into like_track (date, track_entity_id, user_entity_id, liked ) values (current_timestamp(), 2, 1, 1);
insert into like_track (date, track_entity_id, user_entity_id, liked ) values (current_timestamp(), 3, 1, 1);
insert into like_track (date, track_entity_id, user_entity_id, liked ) values (current_timestamp(), 4, 1, 1);
insert into like_track (date, track_entity_id, user_entity_id, liked ) values (current_timestamp(), 5, 1, 1);

insert into dj_list (title, description, owner_id) values ('The Maria DJ list', 'Selected chilly trackEntities', 3);
