...
import cat.tecnocampus.apollofy.djLists.adapter.in.web.ListPlaylistController;
import cat.tecnocampus.apollofy.djLists.adapter.out.persistance.DJListTrackFragmentRepository;
...
public class ApollofyRestControllerTest {
    ...
    @Autowired
    private ListPlaylistController listPlaylistController;
    ...
    void addTracksToPlayListWithTimeRange() throws Exception {
        ...
        final DJListTrackFragmentListing track1 = new DJListTrackFragmentListing (1L, 3000L, 4000L);
        final DJListTrackFragmentListing  track2 = new DJListTrackFragmentListing (2L, 2302L, 67890L);

        List<DJListTrackFragmentListing > dJListTrackFragmentListingList = Arrays.asList(new DJListTrackFragmentListing []{track1, track2});

        // Convert Java DTO to JSON.
        String body = objectMapper.writeValueAsString(dJListTrackFragmentListingList);
    ...
    private static boolean playlistTrackEqualsDTO(DJListTrackFragment DJListTrackFragment, DJListTrackFragmentListing trackToCheck) {
    ...
    private String createTrack(String title, Long duration) throws JsonProcessingException {
        ...
        trackEntity.setDurationSeconds(duration);
        String body = objectMapper.writeValueAsString(trackEntity);
        return body;
    }
